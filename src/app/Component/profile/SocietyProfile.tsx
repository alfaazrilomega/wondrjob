            ...
            <div className="lg:col-span-1">
              <div className="bg-gray-900/50 border border-gray-800 rounded-2xl shadow-2xl p-6 text-center sticky top-12">
                <div className="relative inline-block mb-4">
                  <Image
                    alt={name}
                    className="h-32 w-32 rounded-full mx-auto border-4 border-indigo-500/50"
                    src={
                      user.user_metadata.avatar_url ||
                      `https://ui-avatars.com/api/?name=${name}&background=0E0E10&color=D9ECFF`
                    }
                  />
                ...
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 text-gray-300">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span>{formatDate(date_of_birth)}</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="material-symbols-outlined text-indigo-400">
                        person
                  ...
                  <div className="flex flex-wrap gap-3">
                    {skills.length > 0 ? (
                      ...
                      <p className="text-sm text-gray-500">
                        No skills added yet. Click &apos;Edit Profile&apos; to
                        add your skills.
                      </p>
                    )}
                  </div>
                  ...
                  <div className="space-y-6">
                    {portofolio.length > 0 ? (
                      portofolio.map((item) => (
                        <div
                          key={item.id}
                          className="futuristic-border futuristic-border-hover bg-gray-900/60 rounded-xl p-4 transition-all duration-300"
                        >
                            ...
                            <div className="flex-grow">
                              <div className="flex justify-between items-center">
                                ...
                                <div className="flex items-center gap-2">
                                  <Link
                                    href={`/profile/portfolio/edit/${item.id}`}
