...
export default function ViewApplicantsPage() {
  ...
  const [selectedApplicant, setSelectedApplicant] =
    useState<DetailedApplicant | null>(null);
  ...
  return (
    <>
      <div
        className="p-8 text-gray-200 space-y-8"
              ...
              {!selectedApplicant ? (
                ...
                <div>
                  <h2 className="text-2xl font-bold text-white mb-4">
                    {selectedApplicant.society.name}
                  </h2>
                      ...
                      <p>
                        {selectedApplicant.expectedSalary
                          ? new Intl.NumberFormat("id-ID", {
                              style: "currency",
                              currency: "IDR",
                            }).format(selectedApplicant.expectedSalary)
                          : "Not specified"}
                      </p>
                    </div>
                    <div>
                      ...
                      <p>
                        {selectedApplicant.earliestStartDate
                          ? formatDate(selectedApplicant.earliestStartDate)
                          : "Not specified"}
                      </p>
                    </div>
                    <div>
      ...
      >
        {modalContent && (
          <p>
            Are you sure you want to {modalContent.action} the application for{" "}
            <strong>{modalContent.applicantName}</strong>? This action cannot be
            undone.
          </p>
        )}
      </ConfirmationModal>
